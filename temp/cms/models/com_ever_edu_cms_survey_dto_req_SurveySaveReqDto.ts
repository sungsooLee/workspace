...
export type com_ever_edu_cms_survey_dto_req_SurveySaveReqDto = {
    contentName: string;
    languageCountryCode: com_ever_edu_cms_survey_dto_req_SurveySaveReqDto.languageCountryCode;
    tenantId: number;
    channelUuid: string;
    description?: string;
     ...
     */
    contentAddInfoType?: com_ever_edu_cms_survey_dto_req_SurveySaveReqDto.contentAddInfoType;
     ...
     * 설문지 유형
     */
    surveyType?: com_ever_edu_cms_survey_dto_req_SurveySaveReqDto.surveyType;
    /**
     * 설문지 설명
     */
    comment?: string | null;
...
export namespace com_ever_edu_cms_survey_dto_req_SurveySaveReqDto {
