...
export type com_ever_edu_cms_exam_dto_req_ExamPoolUpdateReqDto = {
    contentUuid: string;
    contentName?: string;
    /**
     * Enum(pms.multilingual.LangCountryCode)
     */
    languageCountryCode?: com_ever_edu_cms_exam_dto_req_ExamPoolUpdateReqDto.languageCountryCode;
    tenantId?: number;
    channelUuid?: string;
    description?: string;
     ...
     */
    contentAddInfoType?: com_ever_edu_cms_exam_dto_req_ExamPoolUpdateReqDto.contentAddInfoType;
    /**
...
export namespace com_ever_edu_cms_exam_dto_req_ExamPoolUpdateReqDto {
    /**
     * Enum(pms.multilingual.LangCountryCode)
     */
