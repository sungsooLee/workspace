...
export type com_ever_edu_cms_image_dto_req_ImageContentUpdateReqDto = {
    contentUuid: string;
    contentName?: string;
    /**
     * Enum(pms.multilingual.LangCountryCode)
     */
    languageCountryCode?: com_ever_edu_cms_image_dto_req_ImageContentUpdateReqDto.languageCountryCode;
    tenantId?: number;
    channelUuid?: string;
    description?: string;
     ...
     */
    contentAddInfoType?: com_ever_edu_cms_image_dto_req_ImageContentUpdateReqDto.contentAddInfoType;
    /**
...
export namespace com_ever_edu_cms_image_dto_req_ImageContentUpdateReqDto {
    /**
     * Enum(pms.multilingual.LangCountryCode)
     */
