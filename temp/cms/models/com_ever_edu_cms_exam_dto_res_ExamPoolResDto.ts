...
export type com_ever_edu_cms_exam_dto_res_ExamPoolResDto = {
    tenantId?: number;
    tenantName?: string;
    channelUuid?: string;
    channelName?: string;
     ...
     */
    languageCountryCode?: com_ever_edu_cms_exam_dto_res_ExamPoolResDto.languageCountryCode;
    /**
     * Enum(cms.content.ContentCreateType)<br>- MANUAL: 직접생성<br>- TRANSLATE: 공유내보내기<br>- SHARED: 번역내보내기
     */
    createType?: com_ever_edu_cms_exam_dto_res_ExamPoolResDto.createType;
    /**
     ...
     */
    contentType?: com_ever_edu_cms_exam_dto_res_ExamPoolResDto.contentType;
    /**
     * Enum(cms.content.ContentStatusCode)<br>- TEMPORARY_SAVE<br>- SAVED<br>- DELETED
     */
    contentStatusCode?: com_ever_edu_cms_exam_dto_res_ExamPoolResDto.contentStatusCode;
     ...
     */
    contentAddInfoType?: com_ever_edu_cms_exam_dto_res_ExamPoolResDto.contentAddInfoType;
...
export namespace com_ever_edu_cms_exam_dto_res_ExamPoolResDto {
    /**
     * Enum(pms.multilingual.LangCountryCode)
     */
