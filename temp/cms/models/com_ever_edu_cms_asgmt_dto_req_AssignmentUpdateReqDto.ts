...
export type com_ever_edu_cms_asgmt_dto_req_AssignmentUpdateReqDto = {
    contentUuid: string;
    contentName?: string;
    languageCountryCode?: com_ever_edu_cms_asgmt_dto_req_AssignmentUpdateReqDto.languageCountryCode;
    tenantId?: number;
    channelUuid?: string;
    description?: string;
    ...
    contentAddInfoType?: com_ever_edu_cms_asgmt_dto_req_AssignmentUpdateReqDto.contentAddInfoType;
...
export namespace com_ever_edu_cms_asgmt_dto_req_AssignmentUpdateReqDto {
