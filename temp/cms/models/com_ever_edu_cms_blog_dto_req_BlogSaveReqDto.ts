...
export type com_ever_edu_cms_blog_dto_req_BlogSaveReqDto = {
    contentName: string;
    /**
     * Enum(pms.multilingual.LangCountryCode)
     */
    languageCountryCode: com_ever_edu_cms_blog_dto_req_BlogSaveReqDto.languageCountryCode;
    tenantId: number;
    channelUuid: string;
    description?: string;
     ...
     */
    contentAddInfoType?: com_ever_edu_cms_blog_dto_req_BlogSaveReqDto.contentAddInfoType;
    /**
...
export namespace com_ever_edu_cms_blog_dto_req_BlogSaveReqDto {
    /**
     * Enum(pms.multilingual.LangCountryCode)
     */
