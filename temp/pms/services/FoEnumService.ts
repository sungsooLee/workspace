...
export class FoEnumService {
    ...
    public static saveEnumCode(
        ...
        return __request(OpenAPI, {
            method: 'POST',
            url: '/user/api/v1/enum/{cdGroupId}/{cdId}/multilingual',
            path: {
                'cdGroupId': cdGroupId,
                'cdId': cdId,
            },
    ...
    public static getEnumCodeList(
        ...
        return __request(OpenAPI, {
            method: 'GET',
            url: '/user/api/v1/enum/{enumNames}',
            path: {
                'enumNames': enumNames,
            },
            errors: {
    ...
    public static getEnumCodeList1(
        ...
        return __request(OpenAPI, {
            method: 'GET',
            url: '/user/api/v1/enum/{cdGroupId}/{cdId}',
            path: {
                'cdGroupId': cdGroupId,
                'cdId': cdId,
            },
