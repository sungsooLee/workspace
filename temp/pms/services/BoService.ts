...
export class BoService {
     ...
     * @throws ApiError
     */
    public static changePasswordByPhoneNumber2(
        requestBody: com_ever_edu_pms_user_dto_req_ExtendPasswordChangeDateReqDto,
    ): CancelablePromise<any> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/admin/api/v1/users/extend-password-change-date',
            body: requestBody,
            mediaType: 'application/json',
            errors: {
                400: `Bad Request`,
    ...
    public static findByGroupIds(
        ...
        return __request(OpenAPI, {
            method: 'GET',
            url: '/admin/api/v1/userGroup/users/by-ids',
            query: {
                'page': page,
                'size': size,
                'sort': sort,
