...
/* tslint:disable */
/* eslint-disable */
import type { com_ever_edu_global_dto_UuidListDto } from '../models/com_ever_edu_global_dto_UuidListDto';
...
import type { com_ever_edu_pms_approval_manage_dto_req_ApprovalLinePopupSearchDto } from '../models/com_ever_edu_pms_approval_manage_dto_req_ApprovalLinePopupSearchDto';
import type { com_ever_edu_pms_approval_manage_dto_req_ApprovalLineTempDeleteReqDto } from '../models/com_ever_edu_pms_approval_manage_dto_req_ApprovalLineTempDeleteReqDto';
import type { com_ever_edu_pms_approval_manage_dto_req_ApprovalLineTempDetailReqDto } from '../models/com_ever_edu_pms_approval_manage_dto_req_ApprovalLineTempDetailReqDto';
...
import type { com_ever_edu_pms_approval_manage_dto_req_ApprovalLineTempUpdateListReqDto } from '../models/com_ever_edu_pms_approval_manage_dto_req_ApprovalLineTempUpdateListReqDto';
...
import type { com_ever_edu_pms_approval_manage_dto_res_ApprovalLineMessageResDto } from '../models/com_ever_edu_pms_approval_manage_dto_res_ApprovalLineMessageResDto';
...
import type { com_ever_edu_pms_holiday_dto_req_HolidaySaveReqDto } from '../models/com_ever_edu_pms_holiday_dto_req_HolidaySaveReqDto';
import type { com_ever_edu_pms_holiday_dto_res_HolidayExcelResDto } from '../models/com_ever_edu_pms_holiday_dto_res_HolidayExcelResDto';
import type { com_ever_edu_pms_holiday_dto_res_HolidayResDto } from '../models/com_ever_edu_pms_holiday_dto_res_HolidayResDto';
...
import type { com_ever_edu_pms_menu_dto_req_FavoritesMenuDnDRequestDto } from '../models/com_ever_edu_pms_menu_dto_req_FavoritesMenuDnDRequestDto';
...
import type { com_ever_edu_pms_menu_dto_req_MenuSaveReqDto$TenantMenuSaveDto } from '../models/com_ever_edu_pms_menu_dto_req_MenuSaveReqDto$TenantMenuSaveDto';
...
import type { com_ever_edu_pms_multilingual_dto_excel_MultilingualExcelUploadDto } from '../models/com_ever_edu_pms_multilingual_dto_excel_MultilingualExcelUploadDto';
...
import type { com_ever_edu_pms_privacyaccess_dto_req_PrivacyAccessLogSearchReqDto$SearchByAdmin } from '../models/com_ever_edu_pms_privacyaccess_dto_req_PrivacyAccessLogSearchReqDto$SearchByAdmin';
import type { com_ever_edu_pms_privacyaccess_dto_res_PrivacyAccessLogResDto$DetailOnAdmin } from '../models/com_ever_edu_pms_privacyaccess_dto_res_PrivacyAccessLogResDto$DetailOnAdmin';
import type { com_ever_edu_pms_role_dto_req_MoveRoleReqDto } from '../models/com_ever_edu_pms_role_dto_req_MoveRoleReqDto';
import type { com_ever_edu_pms_role_dto_req_RoleApplicationApproveReqDto } from '../models/com_ever_edu_pms_role_dto_req_RoleApplicationApproveReqDto';
...
import type { com_ever_edu_pms_tenant_approval_dto_req_TenantApprovalLinePopChoiceReqDto } from '../models/com_ever_edu_pms_tenant_approval_dto_req_TenantApprovalLinePopChoiceReqDto';
import type { com_ever_edu_pms_tenant_approval_dto_req_TenantApprovalLinePopDetailReqDto } from '../models/com_ever_edu_pms_tenant_approval_dto_req_TenantApprovalLinePopDetailReqDto';
import type { com_ever_edu_pms_tenant_approval_dto_req_TenantApprovalLinePopUserReqDto } from '../models/com_ever_edu_pms_tenant_approval_dto_req_TenantApprovalLinePopUserReqDto';
import type { com_ever_edu_pms_tenant_approval_dto_req_TenantApprovalLineRegReqDto } from '../models/com_ever_edu_pms_tenant_approval_dto_req_TenantApprovalLineRegReqDto';
import type { com_ever_edu_pms_tenant_approval_dto_req_TenantApprovalLineSearchReqDto } from '../models/com_ever_edu_pms_tenant_approval_dto_req_TenantApprovalLineSearchReqDto';
...
import type { com_ever_edu_pms_tenant_approval_dto_res_TenantApprovalMessageResDto } from '../models/com_ever_edu_pms_tenant_approval_dto_res_TenantApprovalMessageResDto';
import type { com_ever_edu_pms_tenant_approval_dto_TenantApprovalSettingDto } from '../models/com_ever_edu_pms_tenant_approval_dto_TenantApprovalSettingDto';
...
import type { com_ever_edu_pms_tenant_dto_req_TenantStaticFileCreateReqDto } from '../models/com_ever_edu_pms_tenant_dto_req_TenantStaticFileCreateReqDto';
import type { com_ever_edu_pms_tenant_dto_req_TenantStaticFileUpdateReqDto } from '../models/com_ever_edu_pms_tenant_dto_req_TenantStaticFileUpdateReqDto';
...
import type { com_ever_edu_pms_tenant_dto_res_TenantStaticFileResDto$DetailOnAdmin } from '../models/com_ever_edu_pms_tenant_dto_res_TenantStaticFileResDto$DetailOnAdmin';
...
import type { com_ever_edu_pms_user_dto_res_UserGroupTreeDto } from '../models/com_ever_edu_pms_user_dto_res_UserGroupTreeDto';
import type { com_ever_edu_pms_user_dto_res_UserResDto } from '../models/com_ever_edu_pms_user_dto_res_UserResDto';
import type { com_ever_edu_pms_widget_dto_req_TenantWidgetCreateReqDto } from '../models/com_ever_edu_pms_widget_dto_req_TenantWidgetCreateReqDto';
import type { com_ever_edu_pms_widget_dto_req_TenantWidgetUpdateReqDto } from '../models/com_ever_edu_pms_widget_dto_req_TenantWidgetUpdateReqDto';
...
import type { com_ever_edu_pms_widget_dto_req_WidgetSearchReqDto$SearchByTenant } from '../models/com_ever_edu_pms_widget_dto_req_WidgetSearchReqDto$SearchByTenant';
...
import type { org_springframework_data_domain_PageCom_ever_edu_pms_holiday_dto_res_HolidayListResDto } from '../models/org_springframework_data_domain_PageCom_ever_edu_pms_holiday_dto_res_HolidayListResDto';
...
import type { org_springframework_data_domain_PageCom_ever_edu_pms_privacyaccess_dto_res_PrivacyAccessLogResDto$ListOnAdmin } from '../models/org_springframework_data_domain_PageCom_ever_edu_pms_privacyaccess_dto_res_PrivacyAccessLogResDto$ListOnAdmin';
...
import type { org_springframework_data_domain_PageCom_ever_edu_pms_tenant_dto_res_TenantStaticFileResDto$ListOnAdmin } from '../models/org_springframework_data_domain_PageCom_ever_edu_pms_tenant_dto_res_TenantStaticFileResDto$ListOnAdmin';
...
import type { org_springframework_data_domain_PageCom_ever_edu_pms_widget_dto_res_WidgetResDto$PopupListOnTenant } from '../models/org_springframework_data_domain_PageCom_ever_edu_pms_widget_dto_res_WidgetResDto$PopupListOnTenant';
...
export class BoService {
     ...
     * @returns com_ever_edu_pms_widget_dto_res_WidgetResDto$DetailOnTenant OK
     * @throws ApiError
     */
    public static getTenantWidgetDetail(
        tenantWidgetId: number,
    ): CancelablePromise<com_ever_edu_pms_widget_dto_res_WidgetResDto$DetailOnTenant> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/admin/api/v1/widgets/tenant-mappings/{tenantWidgetId}',
            path: {
     ...
     * @throws ApiError
     */
    public static updateTenantWidget(
        tenantWidgetId: number,
        requestBody: com_ever_edu_pms_widget_dto_req_TenantWidgetUpdateReqDto,
    ): CancelablePromise<com_ever_edu_pms_widget_dto_res_WidgetResDto$DetailOnTenant> {
        return __request(OpenAPI, {
            method: 'PUT',
            url: '/admin/api/v1/widgets/tenant-mappings/{tenantWidgetId}',
     ...
     * @throws ApiError
     */
    public static deleteTenantWidget(
        tenantWidgetId: number,
     ...
     * @throws ApiError
     */
    public static visitTenantAndRole1(
        requestBody: com_ever_edu_pms_user_dto_req_VisitTenantAndRoleReqDto,
    ): CancelablePromise<any> {
        return __request(OpenAPI, {
            method: 'PUT',
            url: '/admin/api/v1/users/visit-tenant-role',
            body: requestBody,
            mediaType: 'application/json',
            errors: {
                400: `Bad Request`,
     ...
     * @throws ApiError
     */
    public static updateTenantProperties1(
        tenantId: number,
     ...
     * @param fileType 파일유형
     * @param expiryStartDate 유효기간시작날짜
     * @param expiryEndDate 유효기간종료날짜
     * @returns org_springframework_data_domain_PageCom_ever_edu_pms_tenant_dto_res_TenantStaticFileResDto$ListOnAdmin OK
     * @throws ApiError
     */
    public static getTenantStaticFileList(
        page?: number,
        size: number = 10,
        sort?: Array<string>,
    ...
    ): CancelablePromise<org_springframework_data_domain_PageCom_ever_edu_pms_tenant_dto_res_TenantStaticFileResDto$ListOnAdmin> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/admin/api/v1/tenants/static-file',
            query: {
                'page': page,
                'size': size,
                'sort': sort,
     ...
     * @throws ApiError
     */
    public static updateTenantStaticFile(
        requestBody: com_ever_edu_pms_tenant_dto_req_TenantStaticFileUpdateReqDto,
    ): CancelablePromise<any> {
        return __request(OpenAPI, {
            method: 'PUT',
            url: '/admin/api/v1/tenants/static-file',
     ...
     * @throws ApiError
     */
    public static createTenantStaticFile(
        requestBody: com_ever_edu_pms_tenant_dto_req_TenantStaticFileCreateReqDto,
    ): CancelablePromise<any> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/admin/api/v1/tenants/static-file',
     ...
     * 테넌트 결재라인관리 수정한다.
     * @param requestBody
     * @returns com_ever_edu_pms_tenant_approval_dto_res_TenantApprovalMessageResDto OK
     * @throws ApiError
     */
    public static updateApprovalLine(
        requestBody: com_ever_edu_pms_tenant_approval_dto_req_TenantApprovalUpdateListReqDto,
    ): CancelablePromise<com_ever_edu_pms_tenant_approval_dto_res_TenantApprovalMessageResDto> {
        return __request(OpenAPI, {
            method: 'PUT',
            url: '/admin/api/v1/tenant_approval/updateTenantApprovalLine',
            body: requestBody,
            mediaType: 'application/json',
            errors: {
                400: `Bad Request`,
    ...
    /**
     * 테넌트-회사-결재라인 사용여부 on/off(테넌트)
     * 결재라인 사용여부 on/off
     * @param requestBody
     * @returns com_ever_edu_pms_tenant_approval_dto_res_TenantApprovalMessageResDto OK
     * @throws ApiError
     */
    public static updateTenantApprovalLineOnOff(
        requestBody: com_ever_edu_pms_tenant_approval_dto_req_TenantApprovalUpdateOnOffReqDto,
    ): CancelablePromise<com_ever_edu_pms_tenant_approval_dto_res_TenantApprovalMessageResDto> {
        return __request(OpenAPI, {
            method: 'PUT',
            url: '/admin/api/v1/tenant_approval/updateTenantApprovalLineUseYn',
            body: requestBody,
            mediaType: 'application/json',
            errors: {
                400: `Bad Request`,
    ...
    /**
     * 플랫폼-결재라인 사용여부 on/off
     * 결재라인 사용여부 on/off
     * @param requestBody
     * @returns com_ever_edu_pms_tenant_approval_dto_res_TenantApprovalMessageResDto OK
     * @throws ApiError
     */
    public static updatePlatformApprovalLineOnOff(
        requestBody: com_ever_edu_pms_tenant_approval_dto_req_TenantApprovalUpdateOnOffReqDto,
    ): CancelablePromise<com_ever_edu_pms_tenant_approval_dto_res_TenantApprovalMessageResDto> {
        return __request(OpenAPI, {
            method: 'PUT',
            url: '/admin/api/v1/tenant_approval/updatePlatformApprovalLineUseYn',
            body: requestBody,
            mediaType: 'application/json',
            errors: {
                400: `Bad Request`,
    ...
    /**
     * 테넌트 결재라인등록
     * 테넌트 결재라인관리 등록한다.(최초등록)
     * @param requestBody
     * @returns com_ever_edu_pms_tenant_approval_dto_res_TenantApprovalMessageResDto OK
     * @throws ApiError
     */
    public static insertApprovalLine(
        requestBody: com_ever_edu_pms_tenant_approval_dto_req_TenantApprovalLineRegReqDto,
    ): CancelablePromise<com_ever_edu_pms_tenant_approval_dto_res_TenantApprovalMessageResDto> {
        return __request(OpenAPI, {
            method: 'PUT',
            url: '/admin/api/v1/tenant_approval/registTenantApprovalLine',
            body: requestBody,
            mediaType: 'application/json',
            errors: {
                400: `Bad Request`,
    ...
    public static updateRole(
        roleId: number,
        requestBody: com_ever_edu_pms_role_dto_req_RoleUpdateReqDto,
    ): CancelablePromise<com_ever_edu_pms_role_dto_res_RoleResDto> {
        return __request(OpenAPI, {
            method: 'PUT',
            url: '/admin/api/v1/roles/{roleId}',
     ...
     * 휴일 상세 조회
     * @param holidayId
     * @returns com_ever_edu_pms_holiday_dto_res_HolidayResDto OK
     * @throws ApiError
     */
    public static selectHolidayInfo(
        holidayId: number,
    ): CancelablePromise<com_ever_edu_pms_holiday_dto_res_HolidayResDto> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/admin/api/v1/holiday/{holidayId}',
            path: {
                'holidayId': holidayId,
            },
            errors: {
     ...
     * @throws ApiError
     */
    public static modifyHolidayInfo(
        holidayId: number,
        requestBody: com_ever_edu_pms_holiday_dto_req_HolidaySaveReqDto,
    ): CancelablePromise<com_ever_edu_pms_holiday_dto_res_HolidayResDto> {
        return __request(OpenAPI, {
            method: 'PUT',
            url: '/admin/api/v1/holiday/{holidayId}',
     ...
     * @throws ApiError
     */
    public static removeHolidayInfo(
        holidayId: number,
    ...
    public static getDepartmentDetail(
        ...
        return __request(OpenAPI, {
            method: 'GET',
            url: '/admin/api/v1/department/{deptId}',
            path: {
                'deptId': deptId,
            },
            errors: {
    ...
    public static changeOrderDepartment(
        ...
        return __request(OpenAPI, {
            method: 'PUT',
            url: '/admin/api/v1/department/{deptId}/dnd',
            path: {
                'deptId': deptId,
            },
            body: requestBody,
     ...
     * @throws ApiError
     */
    public static getCompanyByCompanyCode(
        companyCode: string,
    ): CancelablePromise<com_ever_edu_pms_company_dto_res_CompanyResDto> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/admin/api/v1/companies/{companyCode}',
            path: {
     ...
     * @throws ApiError
     */
    public static selectChannelBaseInfo2(
        channelUuid: string,
    ...
    /**
     * 결재라인관리수정
     * 결재라인관리 수정한다. - approvalLineList는 화면의 순서대로 넣어주세요. 조회시 역순으로 전달합니다.
     * @param requestBody
     * @returns com_ever_edu_pms_approval_manage_dto_res_ApprovalLineSearchResDto OK
     * @throws ApiError
     */
    public static updateApprovalLine1(
     ...
     * @throws ApiError
     */
    public static updateApprovalLineList(
        requestBody: com_ever_edu_pms_approval_manage_dto_req_ApprovalLineTempUpdateListReqDto,
    ): CancelablePromise<com_ever_edu_pms_approval_manage_dto_res_ApprovalLineSearchResDto> {
        return __request(OpenAPI, {
            method: 'PUT',
            url: '/admin/api/v1/approval_manage/updateApprovalLineTempList',
            body: requestBody,
            mediaType: 'application/json',
            errors: {
                400: `Bad Request`,
     ...
     * check테스트
     * @param requestBody
     * @returns com_ever_edu_pms_approval_manage_dto_res_ApprovalLineMessageResDto OK
     * @throws ApiError
     */
    public static testApprovalLine(
        requestBody: com_ever_edu_pms_approval_manage_dto_req_ApprovalLineTempUpdateReqDto,
    ): CancelablePromise<com_ever_edu_pms_approval_manage_dto_res_ApprovalLineMessageResDto> {
        return __request(OpenAPI, {
            method: 'PUT',
            url: '/admin/api/v1/approval_manage/testApprovalLineTemp',
            body: requestBody,
            mediaType: 'application/json',
            errors: {
                400: `Bad Request`,
    ...
    /**
     * 결재라인관리등록
     * 결재라인관리 등록한다. - approvalLineList는 화면의 순서대로 넣어주세요. 조회시 역순으로 전달합니다.
     * @param requestBody
     * @returns com_ever_edu_pms_approval_manage_dto_res_ApprovalLineSearchResDto OK
     * @throws ApiError
     */
    public static insertApprovalLine1(
     ...
     * @throws ApiError
     */
    public static updateTenantWidgetDnD(
        tenantWidgetId: number,
        sortOrder: number,
    ): CancelablePromise<number> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/admin/api/v1/widgets/tenant-mappings/{tenantWidgetId}/dnd',
            path: {
                'tenantWidgetId': tenantWidgetId,
            },
            query: {
     ...
     * @throws ApiError
     */
    public static createTenantWidget(
        tenantId: number,
        requestBody: com_ever_edu_pms_widget_dto_req_TenantWidgetCreateReqDto,
    ): CancelablePromise<Array<com_ever_edu_pms_widget_dto_res_WidgetResDto$DetailOnTenant>> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/admin/api/v1/widgets/tenant-mappings/{tenantId}',
            path: {
                'tenantId': tenantId,
            },
            body: requestBody,
    ...
    public static unlockAccount(
        requestBody: com_ever_edu_global_dto_UuidListDto,
    ): CancelablePromise<any> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/admin/api/v1/users/unlock-account',
            body: requestBody,
            mediaType: 'application/json',
            errors: {
                400: `Bad Request`,
     ...
     * @throws ApiError
     */
    public static rejectAccount(
        requestBody: com_ever_edu_global_dto_UuidListDto,
    ): CancelablePromise<any> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/admin/api/v1/users/reject-account',
            body: requestBody,
            mediaType: 'application/json',
            errors: {
                400: `Bad Request`,
     ...
     * @throws ApiError
     */
    public static approveAccount(
        requestBody: com_ever_edu_global_dto_UuidListDto,
    ): CancelablePromise<any> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/admin/api/v1/users/approve-account',
            body: requestBody,
            mediaType: 'application/json',
            errors: {
                400: `Bad Request`,
    ...
    public static uploadExcelValidation(
        ...
        return __request(OpenAPI, {
            method: 'POST',
            url: '/admin/api/v1/userGroup/excelUploadValidation',
            formData: formData,
            mediaType: 'multipart/form-data',
            errors: {
                400: `Bad Request`,
    ...
    /**
     * 테넌트 정적 파일 유효기간 1년 초과시 사용 불가 처리 (배치용)
     * 테넌트 정적 파일 유효기간 1년 초과시 사용 불가 처리 (배치용)
     * @returns any OK
     * @throws ApiError
     */
    public static expireOutdatedTenantStaticFiles(): CancelablePromise<any> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/admin/api/v1/tenants/static-file/expire',
            errors: {
                400: `Bad Request`,
                401: `Unauthorized`,
                404: `Not Found`,
    ...
    /**
     * 테넌트 내부결재설정 결재양식/사용여부 조회
     * 테넌트 내부결재설정 결재양식/사용여부 조회
     * @param requestBody
     * @returns com_ever_edu_pms_tenant_approval_dto_TenantApprovalSettingDto OK
     * @throws ApiError
     */
    public static selectTenantApprovalSettingList(
        requestBody: com_ever_edu_pms_tenant_approval_dto_req_TenantApprovalLineSearchReqDto,
    ): CancelablePromise<Array<com_ever_edu_pms_tenant_approval_dto_TenantApprovalSettingDto>> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/admin/api/v1/tenant_approval/selectTenantApprovalSettingList',
            body: requestBody,
            mediaType: 'application/json',
            errors: {
                400: `Bad Request`,
     ...
     * 테넌트_회사_결재관리 조회
     * @param requestBody
     * @returns com_ever_edu_pms_tenant_approval_dto_res_TenantApprovalLineSearchResDto OK
     * @throws ApiError
     */
    public static selectTenantApprovalLineList(
        requestBody: com_ever_edu_pms_tenant_approval_dto_req_TenantApprovalLineSearchReqDto,
    ): CancelablePromise<com_ever_edu_pms_tenant_approval_dto_res_TenantApprovalLineSearchResDto> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/admin/api/v1/tenant_approval/selectTenantApprovalLineList',
            body: requestBody,
            mediaType: 'application/json',
            errors: {
                400: `Bad Request`,
     ...
     * 테넌트_회사_결재관리팝업 조회
     * @param requestBody
     * @returns com_ever_edu_pms_tenant_approval_dto_res_TenantApprovalLinePopDetailResDto OK
     * @throws ApiError
     */
    public static selectTenantApprovalLineDetail(
        requestBody: com_ever_edu_pms_tenant_approval_dto_req_TenantApprovalLinePopDetailReqDto,
    ): CancelablePromise<com_ever_edu_pms_tenant_approval_dto_res_TenantApprovalLinePopDetailResDto> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/admin/api/v1/tenant_approval/selectTenantApprovalLineDetail',
            body: requestBody,
            mediaType: 'application/json',
            errors: {
                400: `Bad Request`,
     ...
     * 결재자검색-팝업검색
     * @param requestBody
     * @returns com_ever_edu_pms_tenant_approval_dto_res_TenantApprovalLinePopUserResDto OK
     * @throws ApiError
     */
    public static findApprovalUser(
        requestBody: com_ever_edu_pms_tenant_approval_dto_req_TenantApprovalLinePopUserReqDto,
    ): CancelablePromise<com_ever_edu_pms_tenant_approval_dto_res_TenantApprovalLinePopUserResDto> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/admin/api/v1/tenant_approval/popup/findApprovalUser',
            body: requestBody,
            mediaType: 'application/json',
            errors: {
                400: `Bad Request`,
     ...
     * 결재라인-팝업검색
     * @param requestBody
     * @returns com_ever_edu_pms_tenant_approval_dto_res_TenantApprovalLinePopChoiceResDto OK
     * @throws ApiError
     */
    public static findApprovalLine(
        requestBody: com_ever_edu_pms_tenant_approval_dto_req_TenantApprovalLinePopChoiceReqDto,
    ): CancelablePromise<com_ever_edu_pms_tenant_approval_dto_res_TenantApprovalLinePopChoiceResDto> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/admin/api/v1/tenant_approval/popup/findApprovalLine',
            body: requestBody,
            mediaType: 'application/json',
            errors: {
                400: `Bad Request`,
     ...
     * 역할을 생성한다.
     * @param requestBody
     * @returns com_ever_edu_pms_role_dto_res_RoleResDto Created
     * @throws ApiError
     */
    public static createRole(
        requestBody: com_ever_edu_pms_role_dto_req_RoleCreateReqDto,
    ): CancelablePromise<com_ever_edu_pms_role_dto_res_RoleResDto> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/admin/api/v1/roles',
    ...
    public static saveRoleUsers(
        ...
        return __request(OpenAPI, {
            method: 'POST',
            url: '/admin/api/v1/roles/{roleId}/save-users',
            path: {
                'roleId': roleId,
            },
            body: requestBody,
    ...
    public static saveRoleUserGroups(
        ...
        return __request(OpenAPI, {
            method: 'POST',
            url: '/admin/api/v1/roles/{roleId}/save-user-groups',
            path: {
                'roleId': roleId,
            },
            body: requestBody,
     ...
     * @throws ApiError
     */
    public static saveRoleMenuApis(
        roleId: number,
        requestBody: com_ever_edu_pms_role_dto_req_RoleMenuApiSaveReqDto,
    ): CancelablePromise<any> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/admin/api/v1/roles/{roleId}/save-menu-apis',
            path: {
                'roleId': roleId,
            },
            body: requestBody,
    ...
    public static moveRole(
        ...
        return __request(OpenAPI, {
            method: 'POST',
            url: '/admin/api/v1/roles/{roleId}/move',
            path: {
                'roleId': roleId,
            },
            body: requestBody,
     ...
     * @throws ApiError
     */
    public static getRoleApplications1(
        pageable: org_springdoc_core_converters_models_Pageable,
        companyId?: number,
        userName?: string,
        ...
        return __request(OpenAPI, {
            method: 'GET',
            url: '/admin/api/v1/role-applications',
            query: {
                'pageable': pageable,
                'companyId': companyId,
                'userName': userName,
     ...
     * @throws ApiError
     */
    public static createRoleApplication1(
     ...
     * @throws ApiError
     */
    public static changeRoleApplicationStatus(
        requestBody: com_ever_edu_pms_role_dto_req_RoleApplicationApproveReqDto,
    ): CancelablePromise<any> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/admin/api/v1/role-applications/approve',
            body: requestBody,
            mediaType: 'application/json',
            errors: {
                400: `Bad Request`,
     ...
     * @throws ApiError
     */
    public static processApprovalChannelRequestRejected(
        requestBody: com_ever_edu_pms_channel_dto_req_ChannelRequestApprovalRejectReqDto,
    ): CancelablePromise<number> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/admin/api/v1/request/channel/approval/rejected',
            body: requestBody,
            mediaType: 'application/json',
            errors: {
                400: `Bad Request`,
     ...
     * @throws ApiError
     */
    public static processApprovalChannelRequestApproved(
        requestBody: com_ever_edu_pms_channel_dto_req_ChannelRequestApprovalApproveReqDto,
    ): CancelablePromise<number> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/admin/api/v1/request/channel/approval/approved',
            body: requestBody,
            mediaType: 'application/json',
            errors: {
                400: `Bad Request`,
    ...
    public static uploadExcel(
        targetLocale: string,
        requestBody: Array<com_ever_edu_pms_multilingual_dto_excel_MultilingualExcelUploadDto>,
     ...
     * @throws ApiError
     */
    public static uploadExcelValidation1(
        formData?: {
            file: Blob;
        },
    ): CancelablePromise<com_ever_edu_global_excel_dto_res_ExcelValidationResDto> {
    ...
    public static saveMenu(
        tenantId: number,
        requestBody: com_ever_edu_pms_menu_dto_req_MenuSaveReqDto$TenantMenuSaveDto,
    ): CancelablePromise<any> {
        return __request(OpenAPI, {
            method: 'POST',
     ...
     * @throws ApiError
     */
    public static getFavoritesMenuList(): CancelablePromise<Array<com_ever_edu_pms_menu_dto_res_FavoritesMenuResDto$ListOnAdmin>> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static updateFavoritesMenuDnD(
        favoritesMenuId: number,
        requestBody: com_ever_edu_pms_menu_dto_req_FavoritesMenuDnDRequestDto,
    ): CancelablePromise<number> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/admin/api/v1/menus/favorites/{favoritesMenuId}/dnd',
            path: {
     ...
     * @param size The size of the page to be returned
     * @param sort Sorting criteria in the format: property,(asc|desc). Default sort order is ascending. Multiple sort criteria are supported.
     * @param holidayId 휴일관리 ID
     * @param tenantId 테넌트 ID
     * @param companyCode 회사코드
     * @param holidayType 휴일 유형
     * @param holidayName 휴일명
     * @param startDate 휴일기간 시작일(yyyy-MM-dd)
     * @param endDate 휴일기간 종료일(yyyy-MM-dd)
     * @param holidayDesc 휴일 내용
     * @param isUsed 사용여부
     * @returns org_springframework_data_domain_PageCom_ever_edu_pms_holiday_dto_res_HolidayListResDto OK
     * @throws ApiError
     */
    public static selectHolidayList(
        page?: number,
        size: number = 10,
        sort?: Array<string>,
        holidayId?: string,
        ...
        holidayDesc?: string,
        isUsed?: string,
    ): CancelablePromise<org_springframework_data_domain_PageCom_ever_edu_pms_holiday_dto_res_HolidayListResDto> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/admin/api/v1/holiday',
            query: {
                'page': page,
                'size': size,
                'sort': sort,
     ...
     * 휴일 엑셀파일 일괄 등록
     * @param formData
     * @returns com_ever_edu_pms_holiday_dto_res_HolidayExcelResDto OK
     * @throws ApiError
     */
    public static uploadExcelFileHoliday(
        formData?: {
            multipartFile?: Blob;
        },
     ...
     * @param companyType 회사유형
     * @param regStrDate 등록검색시작일(yyyyMMdd)
     * @param regEndDate 등록검색종료일(yyyyMMdd)
     * @param isUsed 사용여부
     * @param parentDeptId 상위 부서ID
     * @param deptId 부서ID
     ...
     * @param regEndDate 등록검색종료일(yyyyMMdd)
     * @param modifyStartDate 수정검색시작일(yyyyMMdd)
     * @param modifyEndDate 수정검색종료일(yyyyMMdd)
     ...
     * @throws ApiError
     */
    public static selectChannelList(
        roleId: string,
        page?: number,
        size: number = 10,
        sort?: Array<string>,
    ...
    public static mapping(
        requestBody: com_ever_edu_pms_blackwhite_dto_req_BlackAndWhiteMappingReqDto,
    ): CancelablePromise<any> {
        return __request(OpenAPI, {
            method: 'POST',
     ...
     * @throws ApiError
     */
    public static findApprovalLine1(
        requestBody: com_ever_edu_pms_approval_manage_dto_req_ApprovalLinePopupSearchDto,
    ): CancelablePromise<Array<com_ever_edu_pms_approval_manage_dto_res_ApprovalLineSearchResDto>> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/admin/api/v1/approval_manage/popup/findApprovalLine',
            body: requestBody,
            mediaType: 'application/json',
            errors: {
                400: `Bad Request`,
     ...
     * @throws ApiError
     */
    public static selectApprovalLineTempDetail(
        requestBody: com_ever_edu_pms_approval_manage_dto_req_ApprovalLineTempDetailReqDto,
    ): CancelablePromise<com_ever_edu_pms_approval_manage_dto_res_ApprovalLineSearchResDto> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/admin/api/v1/approval_manage/approvalLineTempDetail',
            body: requestBody,
            mediaType: 'application/json',
            errors: {
                400: `Bad Request`,
    ...
    public static findDetailById(
        ...
        return __request(OpenAPI, {
            method: 'GET',
            url: '/internal/api/v1/menus/{menuId}/detail',
            path: {
                'menuId': menuId,
            },
            errors: {
    ...
    /**
     * 플랫폼관리 > 위젯관리 > 위젯 목록 조회
     * 플랫폼관리 > 위젯관리 > 위젯 목록 조회<br><br><b>페이징 정보</b>: <br> - totalElements: 쿼리 결과물의 전체 데이터 갯수 <br> - totalPages: 페이징하였을 때 나오는 총 페이지의 갯수 <br> - size: 페이지 당 데이터 수 설정 값(rows per page) <br> - numberOfElements: 페이지에 존재하는 요소의 갯수(최대 size와 동일) <br> - number: 요소를 가져온 페이지의 번호. 0 ~
     * @param params
     * @param page Zero-based page index (0..N)
     * @param size The size of the page to be returned
     * @param sort Sorting criteria in the format: property,(asc|desc). Default sort order is ascending. Multiple sort criteria are supported.
    ...
    /**
     * 테넌트관리 > 메인위젯관리 > 위젯 조회(팝업)
     * 테넌트관리 > 메인위젯관리 > 위젯 조회(팝업)<br><br><b>페이징 정보</b>: <br> - totalElements: 쿼리 결과물의 전체 데이터 갯수 <br> - totalPages: 페이징하였을 때 나오는 총 페이지의 갯수 <br> - size: 페이지 당 데이터 수 설정 값(rows per page) <br> - numberOfElements: 페이지에 존재하는 요소의 갯수(최대 size와 동일) <br> - number: 요소를 가져온 페이지의 번호. 0 ~
     * @param params
     * @param page Zero-based page index (0..N)
     * @param size The size of the page to be returned
     * @param sort Sorting criteria in the format: property,(asc|desc). Default sort order is ascending. Multiple sort criteria are supported.
     * @returns org_springframework_data_domain_PageCom_ever_edu_pms_widget_dto_res_WidgetResDto$PopupListOnTenant OK
     * @throws ApiError
     */
    public static getWidgetListWithTenantPopup(
        params: com_ever_edu_pms_widget_dto_req_WidgetSearchReqDto$SearchByTenant,
        page?: number,
        size: number = 10,
        sort?: Array<string>,
    ): CancelablePromise<org_springframework_data_domain_PageCom_ever_edu_pms_widget_dto_res_WidgetResDto$PopupListOnTenant> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/admin/api/v1/widgets/with-tenant',
            query: {
                'page': page,
                'size': size,
                'sort': sort,
    ...
    /**
     * 테넌트관리 > 메인위젯관리 > 테넌트 위젯 목록 조회
     * 테넌트관리 > 메인위젯관리 > 테넌트 위젯 목록 조회
     * @param tenantId
     * @returns com_ever_edu_pms_widget_dto_res_WidgetResDto$TenantWidgetListOnTenant OK
     * @throws ApiError
     */
    public static getTenantWidgetList(
        tenantId: number,
    ): CancelablePromise<Array<com_ever_edu_pms_widget_dto_res_WidgetResDto$TenantWidgetListOnTenant>> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static findUserByEmail1(
        email?: string,
    ): CancelablePromise<com_ever_edu_pms_user_dto_res_UserResDto> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/admin/api/v1/users/user/{email}',
            query: {
                'email': email,
            },
            errors: {
     ...
     * @throws ApiError
     */
    public static me1(): CancelablePromise<com_ever_edu_pms_user_dto_res_UserResDto> {
        return __request(OpenAPI, {
            method: 'GET',
    ...
    public static getUserGroupsByUserGroupTypeAndTenantIds(
        ...
        return __request(OpenAPI, {
            method: 'GET',
            url: '/admin/api/v1/userGroup/user-groups',
            query: {
     ...
     * 테넌트 정적 파일 상세 조회
     * @param fileUuid
     * @returns com_ever_edu_pms_tenant_dto_res_TenantStaticFileResDto$DetailOnAdmin OK
     * @throws ApiError
     */
    public static getTenantStaticFileDetail(
        fileUuid: string,
    ): CancelablePromise<com_ever_edu_pms_tenant_dto_res_TenantStaticFileResDto$DetailOnAdmin> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/admin/api/v1/tenants/static-file/{fileUuid}',
            path: {
                'fileUuid': fileUuid,
            },
            errors: {
     ...
     * @throws ApiError
     */
    public static deleteTenantStaticFile(
        fileUuid: string,
    ): CancelablePromise<any> {
        return __request(OpenAPI, {
            method: 'DELETE',
     ...
     * @throws ApiError
     */
    public static getPublicAccessUrlForFile(
        fileUuid: string,
    ): CancelablePromise<any> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/admin/api/v1/tenants/static-file/download/{fileUuid}',
            path: {
                'fileUuid': fileUuid,
            },
            errors: {
     ...
     * @throws ApiError
     */
    public static getTenantSimpleList1(
        tenantId?: string,
        tenantName?: string,
        companyName?: string,
        companyCode?: string,
     ...
     * @throws ApiError
     */
    public static getTenantListPopup1(
        page?: number,
        ...
        return __request(OpenAPI, {
            method: 'GET',
            url: '/admin/api/v1/tenants/popup',
            query: {
                'page': page,
                'size': size,
                'sort': sort,
     ...
     * @throws ApiError
     */
    public static checkDuplicateTenantName1(
        tenantName: string,
        tenantId?: number,
    ...
    /**
     * 역할 사용자 조회
     * 역할 사용자를 조회한다.(정렬 키: 회사(userEntity.companyEntity.name), 조직(userEntity.deptEntity.deptName), 사용자(userEntity.name), 사번(userEntity.employeeNumber), 사용여부(isUsed), 시작일(startDate), 종료일(endDate))
     * @param pageable
     * @param roleId
     * @param companyName
     * @param deptName
    ...
    public static getRoleUsers(
        ...
        return __request(OpenAPI, {
            method: 'GET',
            url: '/admin/api/v1/roles/{roleId}/users',
            path: {
                'roleId': roleId,
            },
            query: {
     ...
     * 역할 유저그룹을 조회한다.
     * @param roleId
     * @returns com_ever_edu_pms_blackwhite_dto_res_WhiteGroupResDto OK
     * @throws ApiError
     */
    public static getRoleUserGroups(
        roleId: number,
    ): CancelablePromise<Array<com_ever_edu_pms_blackwhite_dto_res_WhiteGroupResDto>> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/admin/api/v1/roles/{roleId}/user-groups',
            path: {
                'roleId': roleId,
            },
            errors: {
     ...
     * @throws ApiError
     */
    public static getMyRoles1(
        siteScope: 'FO' | 'BO',
    ): CancelablePromise<Array<com_ever_edu_pms_role_dto_res_RoleResDto>> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/admin/api/v1/roles/me',
            query: {
                'siteScope': siteScope,
            },
            errors: {
     ...
     * @throws ApiError
     */
    public static getRoleApplication1(
        id: number,
    ): CancelablePromise<com_ever_edu_pms_role_dto_res_RoleApplicationResDto> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/admin/api/v1/role-applications/{id}',
            path: {
                'id': id,
            },
            errors: {
     ...
     * @throws ApiError
     */
    public static getRoleApplications2(
        pageable: org_springdoc_core_converters_models_Pageable,
        roleId?: number,
        tenantId?: number,
        channelUuid?: string,
        ...
        return __request(OpenAPI, {
            method: 'GET',
            url: '/admin/api/v1/role-applications/me',
            query: {
                'pageable': pageable,
                'roleId': roleId,
                'tenantId': tenantId,
     ...
     * @param size The size of the page to be returned
     * @param sort Sorting criteria in the format: property,(asc|desc). Default sort order is ascending. Multiple sort criteria are supported.
     * @param channelRequestId 채널신청ID
     * @param channelName 채널 명
     * @param tenantId 테넌트
     * @param tenantName 테넌트이름
     * @param approvalStatusType 신청상태
     * @param isSecretChannel 비공개채널여부
     * @param requesterId 신청자Id
     * @param requesterEmployeeNumber 신청자 사원번호
     * @param requesterName 신청자
     * @param companyName 회사명
     * @param departmentName 조직정보
     * @param regStrDate 신청 검색시작일(yyyyMMdd)
     * @param regEndDate 신청 검색종료일(yyyyMMdd)
     * @param approvalStrDate 결재일 검색시작일(yyyyMMdd)
     * @param approvalEndDate 결재일 검색종료일(yyyyMMdd)
    ...
    public static selectChannelRequestList(
        ...
        return __request(OpenAPI, {
            method: 'GET',
            url: '/admin/api/v1/request/channel',
            query: {
                'page': page,
                'size': size,
                'sort': sort,
                ...
                'regStrDate': regStrDate,
                'regEndDate': regEndDate,
                'approvalStrDate': approvalStrDate,
     ...
     * @throws ApiError
     */
    public static selectChannelRequestPopupList(
        page?: number,
        size: number = 10,
        sort?: Array<string>,
        channelRequestId?: string,
        ...
        return __request(OpenAPI, {
            method: 'GET',
            url: '/admin/api/v1/request/channel/popup',
            query: {
                'page': page,
                'size': size,
                'sort': sort,
     ...
     * @param pageable
     * @param params
     * @returns org_springframework_data_domain_PageCom_ever_edu_pms_privacyaccess_dto_res_PrivacyAccessLogResDto$ListOnAdmin OK
     * @throws ApiError
     */
    public static findPage6(
        pageable: org_springdoc_core_converters_models_Pageable,
        params: com_ever_edu_pms_privacyaccess_dto_req_PrivacyAccessLogSearchReqDto$SearchByAdmin,
    ): CancelablePromise<org_springframework_data_domain_PageCom_ever_edu_pms_privacyaccess_dto_res_PrivacyAccessLogResDto$ListOnAdmin> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/admin/api/v1/privacy-access-log',
            query: {
                'pageable': pageable,
                'params': params,
            },
     ...
     * @returns com_ever_edu_pms_privacyaccess_dto_res_PrivacyAccessLogResDto$DetailOnAdmin OK
     * @throws ApiError
     */
    public static findDetailById1(
        privacyAccessLogId: number,
    ): CancelablePromise<com_ever_edu_pms_privacyaccess_dto_res_PrivacyAccessLogResDto$DetailOnAdmin> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/admin/api/v1/privacy-access-log/{privacyAccessLogId}',
            path: {
                'privacyAccessLogId': privacyAccessLogId,
            },
            errors: {
                400: `Bad Request`,
                401: `Unauthorized`,
    ...
    /**
     * BO GNB 테넌트메뉴목록 트리 조회
     * GNB 메뉴 목록을 트리구조로 조회한다.
     * @param tenantId
     * @param roleIds
     * @param deviceType
    ...
    /**
     * BO 테넌트메뉴맵핑 목록 트리 조회
     * 테넌트메뉴맵핑 목록을 트리구조로 조회한다.
     * @param tenantId
     * @param menuScope
     * @returns com_ever_edu_pms_menu_dto_res_TenantMenuTreeDto OK
     * @throws ApiError
     */
    public static findTenantMenuMapping(
        tenantId: number,
        menuScope: 'FO' | 'BO' | 'EX',
    ): CancelablePromise<com_ever_edu_pms_menu_dto_res_TenantMenuTreeDto> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/admin/api/v1/menus/tenantMappingTree',
            query: {
                'tenantId': tenantId,
                'menuScope': menuScope,
            },
     ...
     * 테넌트맵핑메뉴 상세 조회
     * @param tenantMappingMenuId
     * @returns com_ever_edu_pms_menu_dto_res_TenantMenuResDto$DetailOnAdmin OK
     * @throws ApiError
     */
    public static findTenantMappingMenuDetailById(
        tenantMappingMenuId: number,
    ): CancelablePromise<com_ever_edu_pms_menu_dto_res_TenantMenuResDto$DetailOnAdmin> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/admin/api/v1/menus/tenant/detail/{tenantMappingMenuId}',
            path: {
                'tenantMappingMenuId': tenantMappingMenuId,
            },
            errors: {
     ...
     * @throws ApiError
     */
    public static downloadExcelHolidayList(
        page?: number,
        size: number = 10,
        sort?: Array<string>,
        holidayId?: string,
        ...
        return __request(OpenAPI, {
            method: 'GET',
            url: '/admin/api/v1/holiday/exceldownload',
            query: {
                'page': page,
                'size': size,
                'sort': sort,
    ...
    public static getDepartmentUserList1(
        ...
        deptName?: string,
        employeeNumber?: string,
    ): CancelablePromise<org_springframework_data_domain_PageCom_ever_edu_pms_company_dto_res_CompanyDeptUserResDto> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/admin/api/v1/department/user',
            query: {
                'page': page,
                'size': size,
                'sort': sort,
    ...
    public static getDepartmentListPopup(
        ...
        return __request(OpenAPI, {
            method: 'GET',
            url: '/admin/api/v1/department/popup',
            query: {
                'page': page,
                'size': size,
                'sort': sort,
     ...
     * @param deptName 부서명
     * @param companyId 회사id
     * @param deptId 부서Id (수정만 필수)
     * @returns boolean OK
     * @throws ApiError
     */
    public static getExistDeptName(
        deptName: string,
        companyId?: string,
        deptId?: string,
    ): CancelablePromise<boolean> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/admin/api/v1/department/companyName/exist',
            query: {
                'companyId': companyId,
                'deptName': deptName,
                'deptId': deptId,
    ...
    public static getDepartmentChildList1(
        ...
        return __request(OpenAPI, {
            method: 'GET',
            url: '/admin/api/v1/department/child',
            query: {
                'page': page,
                'size': size,
                'sort': sort,
     ...
     * @throws ApiError
     */
    public static getCompanyListPopup(
        page?: number,
        size: number = 10,
        sort?: Array<string>,
        tenantId?: number,
        ...
        return __request(OpenAPI, {
            method: 'GET',
            url: '/admin/api/v1/companies/popup',
            query: {
                'page': page,
                'size': size,
                'sort': sort,
    ...
    /**
     * 회사코드(companyCode) 중복체크
     * 회사코드의 등록여부를 조회한다.
     * @param companyCode 회사코드
     * @param companyId 회사Id (수정만 필수)
     * @returns boolean OK
     * @throws ApiError
     */
    public static selectExistCompanyCode(
        companyCode: string,
        companyId?: string,
    ): CancelablePromise<boolean> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/admin/api/v1/companies/companyCode/exist',
            query: {
                'companyCode': companyCode,
                'companyId': companyId,
            },
    ...
    public static selectChannelPopupList(
        ...
        return __request(OpenAPI, {
            method: 'GET',
            url: '/admin/api/v1/channel/popup',
            query: {
                'page': page,
                'size': size,
                'sort': sort,
    ...
    public static deleteFavoritesMenu(
        ...
        return __request(OpenAPI, {
            method: 'DELETE',
            url: '/admin/api/v1/menus/favorites/{menuId}',
            path: {
                'menuId': menuId,
            },
            errors: {
    ...
    public static deleteDepartment(
        ...
        return __request(OpenAPI, {
            method: 'DELETE',
            url: '/admin/api/v1/department/remove',
            body: requestBody,
            mediaType: 'application/json',
            errors: {
                400: `Bad Request`,
     ...
     * @throws ApiError
     */
    public static deleteApprovalLine(
        requestBody: com_ever_edu_pms_approval_manage_dto_req_ApprovalLineTempDeleteReqDto,
    ): CancelablePromise<com_ever_edu_pms_approval_manage_dto_res_ApprovalLineMessageResDto> {
        return __request(OpenAPI, {
            method: 'DELETE',
            url: '/admin/api/v1/approval_manage/deleteApprovalLineTemp',
            body: requestBody,
            mediaType: 'application/json',
            errors: {
                400: `Bad Request`,
