...
export type com_ever_edu_pms_company_dto_req_CompanyUpdateReqDto = {
     ...
     * 대표전화번호 국가번호
     */
    companyTelNoCountryCode?: com_ever_edu_pms_company_dto_req_CompanyUpdateReqDto.companyTelNoCountryCode;
    /**
     * 대표전화번호
     */
    companyTelNo?: string;
     ...
     * 대표FAX번호 국가번호
     */
    companyFaxNoCountryCode?: com_ever_edu_pms_company_dto_req_CompanyUpdateReqDto.companyFaxNoCountryCode;
    /**
     * 대표FAX번호
     */
    companyFaxNo?: string;
     ...
     * 비밀번호 인증 유형
     */
    passwordAuthType?: com_ever_edu_pms_company_dto_req_CompanyUpdateReqDto.passwordAuthType;
    /**
     * 2차 인증 사용여부
     */
     ...
     * 2차 인증 유형 유형
     */
    twoFactorAuthType?: com_ever_edu_pms_company_dto_req_CompanyUpdateReqDto.twoFactorAuthType;
    /**
     * 워터마크 사용여부
     */
     ...
     * 워터마크 위치
     */
    watermarkPosition?: com_ever_edu_pms_company_dto_req_CompanyUpdateReqDto.watermarkPosition;
    /**
     * 플레이어 재생바 제어 제한 사용여부
     */
     ...
     * 플레이어 재생바 제어 제한 유형
     */
    playerControlLimitType?: com_ever_edu_pms_company_dto_req_CompanyUpdateReqDto.playerControlLimitType;
    /**
     * 동영상 배속 제한 사용여부
     */
     ...
     * 플레이어 재생바 제어 제한 유형
     */
    playBackRateLimitType?: com_ever_edu_pms_company_dto_req_CompanyUpdateReqDto.playBackRateLimitType;
    /**
     * 학습창 캡처 방지 사용여부
     */
     ...
     * 이러닝 집중 모드 유형
     */
    focusModeType?: com_ever_edu_pms_company_dto_req_CompanyUpdateReqDto.focusModeType;
    /**
     * IP 접근 제한 설정(FO)
     */
     ...
     * 회사담당자사무실전화번호 국가번호
     */
    managerOfficeTelCountryCode?: com_ever_edu_pms_company_dto_req_CompanyUpdateReqDto.managerOfficeTelCountryCode;
    /**
     * 회사담당자사무실 전화번호
     */
     ...
     * 회사담당자전화번호 국가번호
     */
    managerPhoneCountryCode?: com_ever_edu_pms_company_dto_req_CompanyUpdateReqDto.managerPhoneCountryCode;
    /**
     * 회사담당자 전화번호
     */
    managerPhone?: string;
