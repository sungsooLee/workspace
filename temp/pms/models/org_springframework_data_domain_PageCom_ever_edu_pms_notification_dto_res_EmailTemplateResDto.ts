...
export type org_springframework_data_domain_PageCom_ever_edu_pms_notification_dto_res_EmailTemplateResDto = {
    totalElements?: number;
    totalPages?: number;
    size?: number;
    content?: Array<com_ever_edu_pms_notification_dto_res_EmailTemplateResDto>;
    number?: number;
