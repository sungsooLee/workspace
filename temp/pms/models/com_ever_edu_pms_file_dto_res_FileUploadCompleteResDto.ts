...
/* tslint:disable */
/* eslint-disable */
export type com_ever_edu_pms_file_dto_res_FileUploadCompleteResDto = {
    /**
     * 파일 그룹 UUID
     */
    groupUuid?: string;
     ...
     */
    fileType?: com_ever_edu_pms_file_dto_res_FileUploadCompleteResDto.fileType;
    /**
     * 업로드 상태. 코드그룹(pms.file.FileUploadStatus) - COMPLETE|ONGOING(파일 후속 처리 상태)|FAIL(파일 후속 처리 실패)
     */
    uploadStatus?: com_ever_edu_pms_file_dto_res_FileUploadCompleteResDto.uploadStatus;
    /**
     * 사용여부
     */
    isUsed?: boolean;
...
export namespace com_ever_edu_pms_file_dto_res_FileUploadCompleteResDto {
    /**
     * 파일유형. 코드그룹(pms.file.FileType) - IMAGE|VIDEO|DOC|TXT|WEB|ZIP|ETC
     */
