...
export type org_springframework_data_domain_PageCom_ever_edu_pms_company_dto_res_CompanyDeptResDto = {
    totalElements?: number;
    totalPages?: number;
    size?: number;
    content?: Array<com_ever_edu_pms_company_dto_res_CompanyDeptResDto>;
    number?: number;
