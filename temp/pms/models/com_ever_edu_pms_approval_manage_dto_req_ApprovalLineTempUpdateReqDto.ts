...
/* tslint:disable */
/* eslint-disable */
export type com_ever_edu_pms_approval_manage_dto_req_ApprovalLineTempUpdateReqDto = {
    /**
     * 결재라인양식id
     */
     ...
     * 결재업무타입구분
     */
    approvalWorkType?: com_ever_edu_pms_approval_manage_dto_req_ApprovalLineTempUpdateReqDto.approvalWorkType;
    /**
     * 결재업무상세타입구분
     */
    approvalWorkDetailType?: com_ever_edu_pms_approval_manage_dto_req_ApprovalLineTempUpdateReqDto.approvalWorkDetailType;
    /**
     * 결재라인 명
     */
...
export namespace com_ever_edu_pms_approval_manage_dto_req_ApprovalLineTempUpdateReqDto {
    /**
     * 결재업무타입구분
     */
