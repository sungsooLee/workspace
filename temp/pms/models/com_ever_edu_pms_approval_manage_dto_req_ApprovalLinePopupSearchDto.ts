...
/* tslint:disable */
/* eslint-disable */
export type com_ever_edu_pms_approval_manage_dto_req_ApprovalLinePopupSearchDto = {
    /**
     * 결재업무타입구분
     */
    approvalWorkType?: com_ever_edu_pms_approval_manage_dto_req_ApprovalLinePopupSearchDto.approvalWorkType;
    /**
     * 결재업무상세타입구분
     */
    approvalWorkDetailType?: com_ever_edu_pms_approval_manage_dto_req_ApprovalLinePopupSearchDto.approvalWorkDetailType;
};
export namespace com_ever_edu_pms_approval_manage_dto_req_ApprovalLinePopupSearchDto {
    /**
     * 결재업무타입구분
     */
