...
export type org_springframework_data_domain_PageCom_ever_edu_pms_company_dto_res_CompanyResDto = {
    totalPages?: number;
    totalElements?: number;
    size?: number;
    content?: Array<com_ever_edu_pms_company_dto_res_CompanyResDto>;
    number?: number;
