...
/* tslint:disable */
/* eslint-disable */
export type com_ever_edu_pms_tenant_approval_dto_req_TenantApprovalLinePopChoiceReqDto = {
    /**
     * 결재업무타입구분
     */
    approvalWorkType?: com_ever_edu_pms_tenant_approval_dto_req_TenantApprovalLinePopChoiceReqDto.approvalWorkType;
    /**
     * 결재업무상세타입구분
     */
    approvalWorkDetailType?: com_ever_edu_pms_tenant_approval_dto_req_TenantApprovalLinePopChoiceReqDto.approvalWorkDetailType;
};
export namespace com_ever_edu_pms_tenant_approval_dto_req_TenantApprovalLinePopChoiceReqDto {
    /**
     * 결재업무타입구분
     */
