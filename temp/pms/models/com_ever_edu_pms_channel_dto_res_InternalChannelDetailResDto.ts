...
export type com_ever_edu_pms_channel_dto_res_InternalChannelDetailResDto = {
    /**
     * 채널ID
     */
    channelId?: number;
     ...
     * 채널 개설 방식 구분
     */
    channelCreationType?: com_ever_edu_pms_channel_dto_res_InternalChannelDetailResDto.channelCreationType;
    /**
     * 채널 명
     */
    channelName?: string;
     ...
     */
    channelTenatMappingType?: com_ever_edu_pms_channel_dto_res_InternalChannelDetailResDto.channelTenatMappingType;
    /**
     * 채널비밀구분
     */
    channelSecretType?: com_ever_edu_pms_channel_dto_res_InternalChannelDetailResDto.channelSecretType;
    /**
     * 채널 구독 방식 구분
     */
    channelSubscriptionType?: com_ever_edu_pms_channel_dto_res_InternalChannelDetailResDto.channelSubscriptionType;
    /**
     * 테넌트 리스트
     */
     ...
     * 파일 저장 설정
     */
    fileStorageType?: com_ever_edu_pms_channel_dto_res_InternalChannelDetailResDto.fileStorageType;
    /**
     * 노출여부여부
     */
    isDisplay?: boolean;
     ...
     * 채널대상자 설정 구분
     */
    channelTargetUserSettingType?: com_ever_edu_pms_channel_dto_res_InternalChannelDetailResDto.channelTargetUserSettingType;
...
export namespace com_ever_edu_pms_channel_dto_res_InternalChannelDetailResDto {
    /**
     * 채널 개설 방식 구분
     */
