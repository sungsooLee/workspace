...
export type org_springframework_data_domain_PageCom_ever_edu_pms_file_dto_res_GroupInfoResDto = {
    totalElements?: number;
    totalPages?: number;
    size?: number;
    content?: Array<com_ever_edu_pms_file_dto_res_GroupInfoResDto>;
    number?: number;
