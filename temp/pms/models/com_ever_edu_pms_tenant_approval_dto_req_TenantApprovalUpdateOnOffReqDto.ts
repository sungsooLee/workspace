...
/* tslint:disable */
/* eslint-disable */
export type com_ever_edu_pms_tenant_approval_dto_req_TenantApprovalUpdateOnOffReqDto = {
    /**
     * 테넌트ID
     */
    tenantId?: number;
     ...
     * 결재업무타입구분
     */
    approvalWorkType?: com_ever_edu_pms_tenant_approval_dto_req_TenantApprovalUpdateOnOffReqDto.approvalWorkType;
    /**
     * 결재업무상세타입구분
     */
    approvalWorkDetailType?: com_ever_edu_pms_tenant_approval_dto_req_TenantApprovalUpdateOnOffReqDto.approvalWorkDetailType;
};
export namespace com_ever_edu_pms_tenant_approval_dto_req_TenantApprovalUpdateOnOffReqDto {
    /**
     * 결재업무타입구분
     */
