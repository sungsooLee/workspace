...
export type com_ever_edu_pms_company_dto_req_CompanyCreateReqDto = {
     ...
     * 인사 데이터 수동 관리 유형
     */
    hrInfoManageType?: com_ever_edu_pms_company_dto_req_CompanyCreateReqDto.hrInfoManageType;
    /**
     * 회원 가입 유형
     */
     ...
     * 회사담당자사무실전화번호 국가번호
     */
    managerOfficeTelCountryCode?: com_ever_edu_pms_company_dto_req_CompanyCreateReqDto.managerOfficeTelCountryCode;
    /**
     * 회사담당자사무실 전화번호
     */
