...
export type org_springframework_data_domain_PageCom_ever_edu_pms_locale_dto_res_MessageResDto$ListOnAdmin = {
    totalElements?: number;
    totalPages?: number;
    size?: number;
    content?: Array<com_ever_edu_pms_locale_dto_res_MessageResDto$ListOnAdmin>;
    number?: number;
