 ...
 * 결재라인양식선택목록
 */
export type com_ever_edu_pms_tenant_approval_dto_res_choice_TenantApprovalLinePopChoiceFormatDto = {
    /**
     * 테넌트_결재 자동채번ID(유니크)
     */
     ...
     * 결재업무타입구분
     */
    approvalWorkType?: com_ever_edu_pms_tenant_approval_dto_res_choice_TenantApprovalLinePopChoiceFormatDto.approvalWorkType;
    /**
     * 결재업무타입구분명
     */
     ...
     * 결재업무상세타입구분
     */
    approvalWorkDetailType?: com_ever_edu_pms_tenant_approval_dto_res_choice_TenantApprovalLinePopChoiceFormatDto.approvalWorkDetailType;
    /**
     * 결재업무상세타입구분명
     */
     ...
     * 교육신청절차구분
     */
    approvalEduProcessType?: com_ever_edu_pms_tenant_approval_dto_res_choice_TenantApprovalLinePopChoiceFormatDto.approvalEduProcessType;
    /**
     * 예산제한여부
     */
...
export namespace com_ever_edu_pms_tenant_approval_dto_res_choice_TenantApprovalLinePopChoiceFormatDto {
    /**
     * 결재업무타입구분
     */
