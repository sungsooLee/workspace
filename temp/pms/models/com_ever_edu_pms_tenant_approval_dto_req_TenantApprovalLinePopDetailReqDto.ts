...
/* tslint:disable */
/* eslint-disable */
export type com_ever_edu_pms_tenant_approval_dto_req_TenantApprovalLinePopDetailReqDto = {
    /**
     * 테넌트ID
     */
    tenantId?: number;
     ...
     * 결재업무타입구분
     */
    approvalWorkType?: com_ever_edu_pms_tenant_approval_dto_req_TenantApprovalLinePopDetailReqDto.approvalWorkType;
    /**
     * 결재업무상세타입구분
     */
    approvalWorkDetailType?: com_ever_edu_pms_tenant_approval_dto_req_TenantApprovalLinePopDetailReqDto.approvalWorkDetailType;
};
export namespace com_ever_edu_pms_tenant_approval_dto_req_TenantApprovalLinePopDetailReqDto {
    /**
     * 결재업무타입구분
     */
