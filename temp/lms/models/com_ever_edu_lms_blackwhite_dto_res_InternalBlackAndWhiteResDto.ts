...
export type com_ever_edu_lms_blackwhite_dto_res_InternalBlackAndWhiteResDto = {
    /**
     * 유저그룹 매핑 도메인 유형, enum: BlackAndWhiteGroupMappingType
     */
    blackAndWhiteGroupMappingType?: com_ever_edu_lms_blackwhite_dto_res_InternalBlackAndWhiteResDto.blackAndWhiteGroupMappingType;
    /**
...
export namespace com_ever_edu_lms_blackwhite_dto_res_InternalBlackAndWhiteResDto {
    /**
     * 유저그룹 매핑 도메인 유형, enum: BlackAndWhiteGroupMappingType
     */
