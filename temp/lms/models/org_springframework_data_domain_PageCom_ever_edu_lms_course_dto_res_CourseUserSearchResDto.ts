...
export type org_springframework_data_domain_PageCom_ever_edu_lms_course_dto_res_CourseUserSearchResDto = {
    totalPages?: number;
    totalElements?: number;
    size?: number;
    content?: Array<com_ever_edu_lms_course_dto_res_CourseUserSearchResDto>;
    number?: number;
