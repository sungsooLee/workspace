...
export type com_ever_edu_external_blackandwhite_dto_req_BlackAndWhiteUpsertReqDto = {
    /**
     * 유저그룹 매핑 도메인 유형, enum: BlackAndWhiteGroupMappingType
     */
    blackAndWhiteGroupMappingType: com_ever_edu_external_blackandwhite_dto_req_BlackAndWhiteUpsertReqDto.blackAndWhiteGroupMappingType;
    /**
...
export namespace com_ever_edu_external_blackandwhite_dto_req_BlackAndWhiteUpsertReqDto {
    /**
     * 유저그룹 매핑 도메인 유형, enum: BlackAndWhiteGroupMappingType
     */
