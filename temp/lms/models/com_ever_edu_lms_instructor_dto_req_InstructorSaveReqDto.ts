...
/* tslint:disable */
/* eslint-disable */
export type com_ever_edu_lms_instructor_dto_req_InstructorSaveReqDto = {
    /**
     * 테넌트ID
     */
    tenantId: number;
     ...
     * 강사타입(사내/사외)
     */
    instructorType: com_ever_edu_lms_instructor_dto_req_InstructorSaveReqDto.instructorType;
    /**
     * 전임강사 여부
     */
     ...
     * 연락처 국가코드
     */
    telCountryCode: com_ever_edu_lms_instructor_dto_req_InstructorSaveReqDto.telCountryCode;
    /**
     * 연락처
     */
    telNo: string;
