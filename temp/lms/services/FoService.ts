...
import type { com_ever_edu_lms_course_dto_req_CourseSearchReqDto$SearchByUserDto } from '../models/com_ever_edu_lms_course_dto_req_CourseSearchReqDto$SearchByUserDto';
...
import type { com_ever_edu_lms_course_dto_res_CourseResDto$CourseOnUser } from '../models/com_ever_edu_lms_course_dto_res_CourseResDto$CourseOnUser';
...
import type { org_springframework_data_domain_PageCom_ever_edu_lms_course_dto_res_CourseListResDto$OnUser } from '../models/org_springframework_data_domain_PageCom_ever_edu_lms_course_dto_res_CourseListResDto$OnUser';
...
export class FoService {
    ...
    /**
     * 수강신청 가능한 과정 목록 조회
     * 수강신청 가능한 과정 목록을 조회한다.
     * @param pageable
     * @param params
     * @returns org_springframework_data_domain_PageCom_ever_edu_lms_course_dto_res_CourseListResDto$OnUser OK
     * @throws ApiError
     */
    public static findPage2(
        pageable: org_springdoc_core_converters_models_Pageable,
        params: com_ever_edu_lms_course_dto_req_CourseSearchReqDto$SearchByUserDto,
    ): CancelablePromise<org_springframework_data_domain_PageCom_ever_edu_lms_course_dto_res_CourseListResDto$OnUser> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/user/api/v1/courses',
            query: {
                'pageable': pageable,
                'params': params,
            },
     ...
     * @param courseUuid
     * @param courseType
     * @returns com_ever_edu_lms_course_dto_res_CourseResDto$CourseOnUser OK
     * @throws ApiError
     */
    public static findByCourseId(
        courseUuid: string,
        courseType: 'CLASS' | 'ELEARNING' | 'EXAM' | 'SURVEY' | 'LINK' | 'DEFAULT',
    ): CancelablePromise<com_ever_edu_lms_course_dto_res_CourseResDto$CourseOnUser> {
        return __request(OpenAPI, {
            method: 'GET',
