...
import type { com_ever_edu_lms_blackwhite_dto_req_BlackAndWhiteSaveReqDto } from '../models/com_ever_edu_lms_blackwhite_dto_req_BlackAndWhiteSaveReqDto';
import type { com_ever_edu_lms_blackwhite_dto_req_BlackAndWhiteUpdateReqDto } from '../models/com_ever_edu_lms_blackwhite_dto_req_BlackAndWhiteUpdateReqDto';
...
import type { com_ever_edu_lms_course_dto_req_CourseUpsertReqDto$Class_FullUpdate } from '../models/com_ever_edu_lms_course_dto_req_CourseUpsertReqDto$Class_FullUpdate';
import type { com_ever_edu_lms_course_dto_req_CourseUpsertReqDto$Class_WizardStep1 } from '../models/com_ever_edu_lms_course_dto_req_CourseUpsertReqDto$Class_WizardStep1';
import type { com_ever_edu_lms_course_dto_req_CourseUpsertReqDto$Class_WizardStep2 } from '../models/com_ever_edu_lms_course_dto_req_CourseUpsertReqDto$Class_WizardStep2';
import type { com_ever_edu_lms_course_dto_req_CourseUpsertReqDto$Class_WizardStep3 } from '../models/com_ever_edu_lms_course_dto_req_CourseUpsertReqDto$Class_WizardStep3';
import type { com_ever_edu_lms_course_dto_req_CourseUpsertReqDto$Class_WizardStep4 } from '../models/com_ever_edu_lms_course_dto_req_CourseUpsertReqDto$Class_WizardStep4';
import type { com_ever_edu_lms_course_dto_req_CourseUpsertReqDto$Class_WizardStep5 } from '../models/com_ever_edu_lms_course_dto_req_CourseUpsertReqDto$Class_WizardStep5';
import type { com_ever_edu_lms_course_dto_req_CourseUpsertReqDto$ELearning_FullUpdate } from '../models/com_ever_edu_lms_course_dto_req_CourseUpsertReqDto$ELearning_FullUpdate';
import type { com_ever_edu_lms_course_dto_req_CourseUpsertReqDto$ELearning_WizardStep1 } from '../models/com_ever_edu_lms_course_dto_req_CourseUpsertReqDto$ELearning_WizardStep1';
import type { com_ever_edu_lms_course_dto_req_CourseUpsertReqDto$ELearning_WizardStep2 } from '../models/com_ever_edu_lms_course_dto_req_CourseUpsertReqDto$ELearning_WizardStep2';
import type { com_ever_edu_lms_course_dto_req_CourseUpsertReqDto$ELearning_WizardStep3 } from '../models/com_ever_edu_lms_course_dto_req_CourseUpsertReqDto$ELearning_WizardStep3';
import type { com_ever_edu_lms_course_dto_req_CourseUpsertReqDto$ELearning_WizardStep4 } from '../models/com_ever_edu_lms_course_dto_req_CourseUpsertReqDto$ELearning_WizardStep4';
import type { com_ever_edu_lms_course_dto_req_CourseUpsertReqDto$ELearning_WizardStep5 } from '../models/com_ever_edu_lms_course_dto_req_CourseUpsertReqDto$ELearning_WizardStep5';
...
import type { com_ever_edu_lms_course_dto_req_SequenceUpdateReqDto$Class } from '../models/com_ever_edu_lms_course_dto_req_SequenceUpdateReqDto$Class';
import type { com_ever_edu_lms_course_dto_req_SequenceUpdateReqDto$ELearning } from '../models/com_ever_edu_lms_course_dto_req_SequenceUpdateReqDto$ELearning';
...
import type { org_springframework_data_domain_PageCom_ever_edu_lms_course_dto_res_CourseListResDto$OnAdmin } from '../models/org_springframework_data_domain_PageCom_ever_edu_lms_course_dto_res_CourseListResDto$OnAdmin';
...
export class BoService {
    ...
    public static findBySequenceNo1(
        sequenceId: number,
        courseType: 'CLASS' | 'ELEARNING' | 'EXAM' | 'SURVEY' | 'LINK' | 'DEFAULT',
    ...
    public static updateSequence(
        sequenceId: number,
        requestBody: (com_ever_edu_lms_course_dto_req_SequenceUpdateReqDto$Class | com_ever_edu_lms_course_dto_req_SequenceUpdateReqDto$ELearning),
    ): CancelablePromise<number> {
        return __request(OpenAPI, {
            method: 'PUT',
            url: '/admin/api/v1/sequence/{sequenceId}',
    ...
    public static update(
        courseId: number,
        requestBody: (com_ever_edu_lms_course_dto_req_CourseUpsertReqDto$Class_FullUpdate | com_ever_edu_lms_course_dto_req_CourseUpsertReqDto$ELearning_FullUpdate),
    ): CancelablePromise<number> {
        return __request(OpenAPI, {
            method: 'PUT',
            url: '/admin/api/v1/course/{courseId}',
    ...
    public static wizard5(
        courseId: number,
        requestBody: (com_ever_edu_lms_course_dto_req_CourseUpsertReqDto$Class_WizardStep5 | com_ever_edu_lms_course_dto_req_CourseUpsertReqDto$ELearning_WizardStep5),
    ): CancelablePromise<number> {
        return __request(OpenAPI, {
            method: 'PUT',
    ...
    public static wizard4(
        courseId: number,
        requestBody: (com_ever_edu_lms_course_dto_req_CourseUpsertReqDto$Class_WizardStep4 | com_ever_edu_lms_course_dto_req_CourseUpsertReqDto$ELearning_WizardStep4),
    ): CancelablePromise<number> {
        return __request(OpenAPI, {
            method: 'PUT',
    ...
    public static wizard3(
        courseId: number,
        requestBody: (com_ever_edu_lms_course_dto_req_CourseUpsertReqDto$Class_WizardStep3 | com_ever_edu_lms_course_dto_req_CourseUpsertReqDto$ELearning_WizardStep3),
    ): CancelablePromise<number> {
        return __request(OpenAPI, {
            method: 'PUT',
    ...
    public static wizard2(
        courseId: number,
        requestBody: (com_ever_edu_lms_course_dto_req_CourseUpsertReqDto$Class_WizardStep2 | com_ever_edu_lms_course_dto_req_CourseUpsertReqDto$ELearning_WizardStep2),
    ): CancelablePromise<number> {
        return __request(OpenAPI, {
            method: 'PUT',
    ...
    public static wizard1(
        courseId: number,
        requestBody: (com_ever_edu_lms_course_dto_req_CourseUpsertReqDto$Class_WizardStep1 | com_ever_edu_lms_course_dto_req_CourseUpsertReqDto$ELearning_WizardStep1),
    ): CancelablePromise<number> {
        return __request(OpenAPI, {
            method: 'PUT',
    ...
    public static saveSequence(
        requestBody: (com_ever_edu_lms_course_dto_req_SequenceSaveReqDto$Class | com_ever_edu_lms_course_dto_req_SequenceSaveReqDto$ELearning),
    ): CancelablePromise<number> {
        return __request(OpenAPI, {
            method: 'POST',
    ...
    public static update5(
        requestBody: com_ever_edu_lms_blackwhite_dto_req_BlackAndWhiteUpdateReqDto,
    ): CancelablePromise<number> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/admin/api/v1/black-and-white/update',
            body: requestBody,
            mediaType: 'application/json',
            errors: {
                400: `Bad Request`,
     ...
     */
    public static save1(
        requestBody: com_ever_edu_lms_blackwhite_dto_req_BlackAndWhiteSaveReqDto,
    ): CancelablePromise<number> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/admin/api/v1/black-and-white/save',
            body: requestBody,
            mediaType: 'application/json',
            errors: {
                400: `Bad Request`,
    ...
    public static getRecentSearchLogs(
        ...
        return __request(OpenAPI, {
            method: 'GET',
            url: '/user/api/v1/search-logs/{userId}/recent',
            path: {
                'userId': userId,
            },
            errors: {
    ...
    public static getPopularSearchLogs(
        ...
        return __request(OpenAPI, {
            method: 'GET',
            url: '/user/api/v1/search-logs/{tenantId}/top-searches',
            path: {
                'tenantId': tenantId,
            },
            errors: {
     ...
     * @param pageable
     * @param params
     * @returns org_springframework_data_domain_PageCom_ever_edu_lms_course_dto_res_CourseListResDto$OnAdmin OK
     * @throws ApiError
     */
    public static findPage7(
        pageable: org_springdoc_core_converters_models_Pageable,
        params: com_ever_edu_lms_course_dto_req_CourseSearchReqDto$SearchByAdminDto,
    ): CancelablePromise<org_springframework_data_domain_PageCom_ever_edu_lms_course_dto_res_CourseListResDto$OnAdmin> {
        return __request(OpenAPI, {
            method: 'GET',
    ...
    public static deleteSearchLog(
        ...
        return __request(OpenAPI, {
            method: 'DELETE',
            url: '/user/api/v1/search-logs/{userId}/{keyword}',
            path: {
                'userId': userId,
                'keyword': keyword,
            },
