...
type RoundDetailComponentProps = {
  courseId: number;
  roundId: number;
};
 ...
 * @returns
 */
const RoundDetailComponent = ({ courseId, roundId }: RoundDetailComponentProps) => {
  console.log('##detail=>', courseId);
  console.log('##detail=>', roundId);
...
export const RoundDetail = RoundDetailComponent;
