...
export function useCoursePackageDetailBasicInfo() {
    ...
    const run = onSubmit(async (data) => {
      ...
      if (await saveConfirm()) {
        const requestData = {
          ...
          isUsed: data.isUsed,
          exposureStartDt: data.exposureRange.from,
          exposureEndDt: data.exposureRange.to,
          language: data.language,
          tenantIds: data.tenantIds,
        };
        createCoursePackage(requestData);
      }
    });
