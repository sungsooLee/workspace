...
const TenantDetailWidgetListComponent: FC<{}> = ({}) => {
...
TenantDetailWidgetListComponent.displayName = 'MainWidget';
export const TenantDetailWidgetList = TenantDetailWidgetListComponent;
