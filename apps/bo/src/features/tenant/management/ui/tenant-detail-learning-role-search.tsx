...
import { Button, Input, TreeView, TreeNode } from '@learnway/ui';
/* style */
...
const TenantDetailLearningRoleSearchComponent: FC<any> = ({ menuScope }) => {
  // tree
  ...
  return (
    <div className={cn(styles.start, styles.wrap)}>
      <FormSubTitle
        ...
        actionNode={
          <>
            <Input type={'text'} showSearchIcon iconType={'tree'} placeholder={'검색'} />
...
TenantDetailLearningRoleSearchComponent.displayName = 'RoleListSearch';
export const TenantDetailLearningRoleSearch = TenantDetailLearningRoleSearchComponent;
