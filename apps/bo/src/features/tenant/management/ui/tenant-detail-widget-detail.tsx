...
const TenantDetailWidgetDetailComponent: FC<{}> = ({}) => {
  // Table
...
// TenantDetailWidgetDetailComponent.displayName = 'MainWidgetDetail';
export const TenantDetailWidgetDetail = TenantDetailWidgetDetailComponent;
