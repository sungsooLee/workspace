...
const SelectFormFieldComponent = forwardRef<React.ElementRef<typeof Primitive.Root>, any>(
  ({ control, value, onChange, options, optionsConfig }, ref) => {
    ...
    return (
      <Select ref={ref} value={value} onChange={handleSelectChange} options={currentOptions} />
    );
  },
);
