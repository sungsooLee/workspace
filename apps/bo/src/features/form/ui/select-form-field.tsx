...
interface SelectFormFieldProps extends BaseFormFieldProps<string> {
  options: SelectOption[];
  optionsConfig: any;
}

const SelectFormFieldComponent = forwardRef<
...
>(({ control, value, onChange, options, optionsConfig }, ref) => {
  ...
  return <Select ref={ref} value={value} onChange={handleSelectChange} options={currentOptions} />;
});

SelectFormFieldComponent.displayName = 'SelectFormField';
export const SelectFormField = SelectFormFieldComponent;
