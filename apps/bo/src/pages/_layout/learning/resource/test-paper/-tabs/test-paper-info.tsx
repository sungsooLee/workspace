...
import {
  convertDetailInfoToFormData,
  getExamSaveRequestDataFromFormData,
} from '@pages/_layout/learning/resource/test-paper/-common/common';

const TestPaperInfoComponent = forwardRef<TabFormRef, ExamBasicInfoProps>(
  ({ contentUuid = '', tenantId, mode, data, hasMapping = false }, ref) => {
    ...
    return (
      ...
      <form ref={formRef} onSubmit={onSubmit(saveBasicInfo)}>
