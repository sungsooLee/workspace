  ...
  ({ basicInfoForm, contentUuid = '', tenantId, mode, data = {}, hasMapping = false }, ref) => {
    ...
    return (
      <SplitPanel size={['auto', 416]} divider>
        <div>
          <form ref={formRef} onSubmit={onSubmit && saveBasicInfo && onSubmit(saveBasicInfo)}>
            <div className={styles.wrap}>
              ...
              <ContentsRow>
                ...
                <FormRow2
                  ...
                  element={
                    <Input type="number" suffixText={t('개')} min={0} disabled={hasMapping} />
                  }
                  placeholder="0"
                />
                {/* 페이지별 문항수 */}
                ...
                <FormRow2
                  ...
                  validation={{ required: true }}
                  element={
                    <Input type="number" suffixText={t('분')} min={0} disabled={hasMapping} />
                  }
                  placeholder="0"
                />
                ...
                <FormRow2
                  ...
                  validation={{ required: true }}
                  element={
                    <Input type="number" suffixText={t('회')} min={0} disabled={hasMapping} />
                  }
                  placeholder="0"
                />
              </ContentsRow>
              ...
              <ContentsRow type="horizontal" className="inactive">
                ...
                <FormRow2
                  ...
                  tooltip={t(
                    '시험 문항을 순차적으로 풀어야 한다면 문항이동 제어기능을 사용하세요.',
                  )}
                />
              </ContentsRow>
              ...
              <FormDisplay
                provider={provider}
                dependencies={[{ name: 'isShowResult', value: true }]}
              >
