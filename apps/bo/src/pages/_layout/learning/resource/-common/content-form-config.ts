...
import { CODE_GROUP, DynamicFormConfig, S3_PATH } from '@learnway/hooks';

// 추후 useDyanamicForm2로 변경하게 되면 삭제 예정
export const mediaContentFormConfig = (options: { hasMapping: boolean }): DynamicFormConfig => ({
  builders: [
    {
