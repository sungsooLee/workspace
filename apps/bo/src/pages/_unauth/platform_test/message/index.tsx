...
function RouteComponent() {
  ...
  const handleMultilingualManageClick = (code?: string) => {
    console.log('handleMultilingualManageClick');
    // 다국어 관리 화면 이동
    router.navigate({
      to: '/platform/system/multilingual',
      state: {
        keyType: 'MESSAGE', // 다국어 분류 - 메세지
        // multilinguaKey: cdId,
      },
    });
  };
...
const gridConfig = {
  ...
  title: t('목록'),
  data: [{ labelMessageType: 'xxx', labelMessageMultilingulKey: 'ccc' }],
  columns: [
    {
      name: 'no1',
      label: 'NO.',
