  ...
  const handleRegister = async () => {
    ...
    switch (typeResult) {
      ...
      case LEARNING_TYPE.IMAGE: {
        router.navigate({ to: '/learning_test/resource/view/image' });
        break;
      }
      // 기타
      case LEARNING_TYPE.ETC: {
        router.navigate({ to: '/learning_test/resource/view/etc' });
        break;
      }
      // 외부링크
      case LEARNING_TYPE.EXTERNAL_LINK: {
        router.navigate({ to: '/learning_test/resource/view/link' });
        break;
      }
      // 외부위탁
