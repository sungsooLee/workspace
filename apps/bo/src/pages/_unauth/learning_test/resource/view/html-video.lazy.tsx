...
import { MovieInfo, SharedChannelGridFormField } from '../../../../../features/learning';
...
export const Route = createLazyFileRoute('/_unauth/learning_test/resource/view/html-video')({
        ...
        <MainContents>
          ...
          <ContentsRow>
            <FormRow
              provider={provider}
              name={'videoDuration'}
              element={<VideoDurationFormField />}
            ></FormRow>
          </ContentsRow>
          <ContentsRow>
            {/*썸네일*/}
