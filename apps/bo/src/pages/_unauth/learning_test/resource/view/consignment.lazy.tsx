...
export const Route = createLazyFileRoute('/_unauth/learning_test/resource/view/consignment')({
    ...
    <form onSubmit={onSubmit(handleFormSubmit)}>
      <PageContainer>
        ...
        <MainContents>
          ...
          {/*외주업체 과정코드*/}
          <ContentsRow>
            <FormRow provider={provider} name={'subjectCode'} />
          </ContentsRow>
          {/*외부학습시작 URL(비표준)*/}
          <ContentsRow>
            <FormRow provider={provider} name={'url'} />
          </ContentsRow>
          {/*외부학습시작 파라미터*/}
          <ContentsRow>
            <FormRow
              provider={provider}
              name={'parameters'}
              element={<ConsignmentParametersFormField />}
            />
          </ContentsRow>
          {/*썸네일*/}
          <ContentsRow>
