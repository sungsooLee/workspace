...
import { CompanyLoginRestriction } from './company';
...
export type CompanyDept = {
   ...
   * 회사유형
   */
  companyType?: CompanyDept.companyType;
  /**
   * 연동시스템 사용여부
   */
   ...
   * 연동시스템 유형
   */
  linkageType?: CompanyDept.linkageType;
  /**
   * 연동시스템
   */
  linkageSystem?: CompanyDept.linkageSystem;
  /**
   * 로그인 제한 정보
   */
