...
export type Instructors = {
   ...
   * 강사타입(사내/사외)
   */
  instructorType?: InstructorDto.instructorType;
  /**
   * 이름
   */
   ...
   * 연락처 국가코드
   */
  telCountryCode?: InstructorDto.telCountryCode;
  /**
   * 연락처
   */
  telNo?: string;
...
export type InstructorHistory = {
   ...
   * 과정 타입
   */
  courseType?: InstructorDto.courseType;
  /**
   * 과정명
   */
  courseName?: string;
...
export namespace InstructorDto {
  /**
   * 강사타입(사내/사외)
   */
