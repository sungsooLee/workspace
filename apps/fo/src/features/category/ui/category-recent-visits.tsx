...
const CategoryRecentVisitsCompoment = ({ items, handleOnLink }: RecentVisitsProps) => {
              ...
              {items.map((item, index) => (
                <SwiperSlide key={index} className={styles.slide}>
                  <Chip
                    ...
                    onClick={() => handleOnLink(item.value)}
                  />
                </SwiperSlide>
              ))}
            </div>
...
export const CategoryRecentVisits = memo(CategoryRecentVisitsCompoment);
