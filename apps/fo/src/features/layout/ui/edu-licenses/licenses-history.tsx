...
import styles from '@learnway/styles/fo/features/layout/ui/edu-licenses/licenses-history.module.css';
import searchBoxStyles from '@learnway/styles/fo/features/layout/ui/edu-licenses/search-box.module.css';
