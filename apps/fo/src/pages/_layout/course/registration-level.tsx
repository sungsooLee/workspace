...
import styles from '@learnway/styles/fo/pages/_layout/course/registration-level.module.css';
import { useCreateSingleCourseApplicationQueue } from '@entities/enroll';
import { LangLevelTest } from '@types';
export const Route = createFileRoute('/_layout/course/registration-level')({
