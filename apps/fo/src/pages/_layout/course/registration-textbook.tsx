...
import styles from '@learnway/styles/fo/pages/_layout/course/registration-textbook.module.css';
import { useCreateSingleCourseApplicationQueue } from '@entities/enroll';
import { BookDeliveryInfo } from '@types';
export const Route = createFileRoute('/_layout/course/registration-textbook')({
