...
function RouteComponent() {
  const icons = [
    ...
    {
      name: 'IcoFooter01',
      Component: <IcoFooter01 width={24} height={24} />,
      file: 'ic_footer_01.svg (색상변경금지)',
    },
    {
      name: 'IcoFooter02',
      Component: <IcoFooter02 width={24} height={24} />,
      file: 'ic_footer_02.svg (색상변경금지)',
    },
    {
      name: 'IcoFooter03',
      Component: <IcoFooter03 width={24} height={24} />,
      file: 'ic_footer_03.svg (색상변경금지)',
    },
    {
      name: 'IcoFooter04',
      Component: <IcoFooter04 width={24} height={24} />,
      file: 'ic_footer_04.svg (색상변경금지)',
    },
    {
      name: 'IcoFooter05',
      Component: <IcoFooter05 width={24} height={24} />,
      file: 'ic_footer_05.svg (색상변경금지)',
    },
    {
      name: 'IcoFooterOn01',
      Component: <IcoFooterOn01 width={24} height={24} />,
      file: 'ic_footer_on_01.svg (색상변경금지)',
    },
    {
      name: 'IcoFooterOn02',
      Component: <IcoFooterOn02 width={24} height={24} />,
      file: 'ic_footer_on_02.svg (색상변경금지)',
    },
    {
      name: 'IcoFooterOn03',
      Component: <IcoFooterOn03 width={24} height={24} />,
      file: 'ic_footer_on_03.svg (색상변경금지)',
    },
    {
      name: 'IcoFooterOn04',
      Component: <IcoFooterOn04 width={24} height={24} />,
      file: 'ic_footer_on_04.svg (색상변경금지)',
    },
    {
      name: 'IcoFooterOn05',
      Component: <IcoFooterOn05 width={24} height={24} />,
      file: 'ic_footer_on_05.svg (색상변경금지)',
    },
    {
      name: 'IcoHeartFill',
      Component: <IcoHeartFill width={24} height={24} />,
      file: 'ic_heart_fill.svg (색상변경금지)',
    },
    {
      name: 'IcoBookFill',
