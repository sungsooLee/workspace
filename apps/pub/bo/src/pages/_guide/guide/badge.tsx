...
<Badge option={{ label: 'html', value: 'html' }} />;`}
      ...
      <div className="group">
        ...
        <div className="flex_box">
          <div className="desc">
            <Badge option={{ label: '1', value: 'A' }} variant="number" />
            <Badge option={{ label: '2', value: 'B' }} variant="number" />
            <Badge option={{ label: '3', value: 'C' }} variant="number" />
            <Badge option={{ label: '99', value: 'D' }} variant="number" />
          </div>
        </div>
      </div>
    </div>
