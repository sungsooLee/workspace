      ...
      <div className={`${signupStyles.start} ${signupStyles.auth_wrap}`}>
        <div className={signupStyles.auth_box}>
          <div className={signupStyles.success_info}>
            <i className={cn(signupStyles.ico, signupStyles.fail)}>
              <IcoCompanion width={56} height={56} />
            </i>
            <h3 className={signupStyles.title}>관리자 권한 신청이 반려되었습니다.</h3>
          ...
          <div className={`${formStyles.col} ${signupStyles.auth_form}`}>
            ...
            {/* form_item */}
            <div className={formStyles.form_item}>
              <label htmlFor="name-approver" className={formStyles.form_label}>
                <span className={formStyles.form_text}>승인자</span>
                {/* 필수 케이스 */}
                <span className={cn(formStyles.status, formStyles.required)}>
                  <IcoFormRequired width={12} height={12} />
                </span>
            ...
            {/* form_item */}
            <div className={formStyles.form_item}>
              <label htmlFor="name-reason2" className={formStyles.form_label}>
          ...
          <div className={signupStyles.btn_wrap}>
            <Button variant="gray" size="xl" className="font-normal">
              확인
            </Button>
