...
import { AgreementDetailPopup, TenantSearchPopup } from '../../features/auth'; // 테넌트명 조회 팝업
      ...
      <div className={`${styles.start} ${styles.auth_wrap} ${styles.signup_step}`}>
        <div className={cn(styles.auth_box, 'auth--box')}>
          ...
          <div className="no_line col">
            <ContentsRow>
              <div className={formStyles.form_item}>
                <label htmlFor="tenant-name" className={formStyles.form_label}>
                ...
                <div className={formStyles.input_box}>
                  <Input id="name" type="text" placeholder="" value="L&D플랫폼" readOnly />
                </div>
              </div>
            </ContentsRow>
            ...
            <ContentsRow>
              <div className={formStyles.form_item}>
                ...
                <div className={formStyles.input_box}>
                  <Input id="name" type="text" placeholder="" value="현대" readOnly />
                </div>
              </div>
            </ContentsRow>
            <ContentsRow>
              <div className={formStyles.form_item}>
                <label htmlFor="tenant-admin" className={formStyles.form_label}>
                ...
                <div className={formStyles.input_box}>
                  <Input id="name" type="text" placeholder="" value="김현대" readOnly />
                </div>
              </div>
            </ContentsRow>
          </div>
