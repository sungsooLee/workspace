...
import { Button, Input, TreeNode, TreeView } from '@learnway/ui';
/* style */
...
const RoleListSearchComponent: FC<{}> = ({}) => {
  // tree
  ...
  return (
    <div className={cn(styles.start, styles.wrap)}>
      <FormSubTitle
        ...
        actionNode={
          <>
            <Input type={'text'} showSearchIcon searchIconType={'tree'} placeholder={'검색'} />
...
RoleListSearchComponent.displayName = 'RoleListSearch';
export const RoleListSearch = RoleListSearchComponent;
