...
import { useDebounce } from '../hooks/use-de-bounce';
...
function TableHoverActionsContainer({
  ...
  return (
    <>
      {isShownRow && (
        <button
          className={'nlp--editor-table-add-rows'}
          style={{ ...position }}
      ...
      {isShownColumn && (
        <button
          className={'nlp--editor-table-add-columns'}
          style={{ ...position }}
...
function getMouseInfo(event: MouseEvent): {
  ...
  if (isHTMLElement(target)) {
    const tableDOMNode = target.closest<HTMLElement>(
      'td.nlp--editor-table-cell, th.nlp--editor-table-cell',
    );

    const isOutside = !(
      tableDOMNode ||
      target.closest<HTMLElement>('button.nlp--editor-table-add-rows') ||
      target.closest<HTMLElement>('button.nlp--editor-table-add-columns') ||
