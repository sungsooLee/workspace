  ...
  const colorGroups = [
    {
      ...
      colors: [
        { name: '--gray10', textColor: '--FO_white', code: '#131C30' },
        { name: '--gray9', textColor: '--FO_white', code: '#3E4550' },
        { name: '--gray8', textColor: '--FO_white', code: '#5C636E' },
        { name: '--gray7', textColor: '--FO_white', code: '#747D91' },
