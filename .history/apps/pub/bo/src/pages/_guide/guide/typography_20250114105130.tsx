...
import CodeCopy from '../../config/_CodeCopy';
...
function RouteComponent() {
  ...
  return (
    <div>
      <h2 className="guide-tit2">Typography Guide</h2>
      <p className="loc sass">상단 SCSS 위치 : /src/assets/styles/_typography.scss</p>
      <p className="loc sass">상단 SCSS(_mixins.scss) 위치 : /src/assets/styles/_mixins.scss</p>
      <p className="info">
      ...
      <div>
        {groups.map((group, groupIndex) => (
          <div key={groupIndex} className="group">
            <h3 className="guide-tit3">{group.groupName}</h3>
